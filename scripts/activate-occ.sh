...
if [ -z "$LATEST_REPORT" ]; then
    ...
    echo ""
    echo -e "${BLUE}💡 Standard OCC Activation Prompt (copy if you want OCC to check for updates):${NC}"
    echo ""
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${GREEN}Check the AI Collaboration Framework in the repository for new instructions and reports in .ai-framework/communications/. Pull latest changes and report status.${NC}"
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    ...
    echo ""
    echo -e "${BLUE}📋 Standard OCC Activation Prompt (copy and paste to Browser Claude):${NC}"
    echo ""
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${GREEN}Check the AI Collaboration Framework in the repository for new instructions and reports in .ai-framework/communications/. Pull latest changes, address any validation reports, commit your response, and push back to GitHub.${NC}"
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    echo -e "${BLUE}📍 Repository:${NC} ${GIT_REMOTE}"
    echo -e "${BLUE}🌿 Branch:${NC} ${CURRENT_BRANCH}"
